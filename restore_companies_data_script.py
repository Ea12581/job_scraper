...
exists_companies_info_path = "companies_info.JSON"
path_to_companies_json = "companies_ids_example.JSON"
extract_basic_company_info(exists_companies_info_path, path_to_companies_json)